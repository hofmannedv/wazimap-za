...
ALTER TABLE IF EXISTS ONLY public.youth_difficulty_functioning_function_type DROP CONSTRAINT IF EXISTS youth_difficulty_functioning_pkey;
DROP TABLE IF EXISTS public.youth_difficulty_functioning_function_type;
SET search_path = public, pg_catalog;
...
--
-- Name: youth_difficulty_functioning_function_type; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE youth_difficulty_functioning_function_type (
...
--
-- Data for Name: youth_difficulty_functioning_function_type; Type: TABLE DATA; Schema: public; Owner: -
--

COPY youth_difficulty_functioning_function_type (geo_level, geo_code, "function type", total) FROM stdin;
...
ALTER TABLE ONLY youth_difficulty_functioning_function_type
