...
DROP INDEX IF EXISTS public.auth_user_groups_e8701ad4;
DROP INDEX IF EXISTS public.auth_user_groups_0e939a4f;
ALTER TABLE IF EXISTS ONLY public.auth_user_groups DROP CONSTRAINT IF EXISTS auth_user_groups_user_id_94350c0c_uniq;
