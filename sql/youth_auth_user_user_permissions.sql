...
ALTER TABLE IF EXISTS ONLY public.auth_user_user_permissions DROP CONSTRAINT IF EXISTS auth_user_user_per_permission_id_1fbb5f2c_fk_auth_permission_id;
DROP INDEX IF EXISTS public.auth_user_user_permissions_e8701ad4;
DROP INDEX IF EXISTS public.auth_user_user_permissions_8373b171;
ALTER TABLE IF EXISTS ONLY public.auth_user_user_permissions DROP CONSTRAINT IF EXISTS auth_user_user_permissions_user_id_14a6b632_uniq;
